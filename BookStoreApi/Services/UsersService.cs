...
namespace BookStoreApi.Services
{
    public class UsersService
    {
        ...
        public UsersService(IOptions<BookStoreDatabaseSettings> bookStoreDatabaseSettings, IUtilitiesService utilitiesService)
        {
        ...
        {
            newUser.Password = _utilitiesService.ConvertToSha256(newUser.Password);
